...
namespace UnityEngine.UI
{
    ...
    /// <summary>
    /// EventType component for making a child RectTransform scroll with reuseable content.
    /// </summary>
    /// <remarks>
    ...
    public abstract class LoopScrollRectBase : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        /// </summary>
        /// <remarks>
        /// The deceleration rate is the speed reduction per second. EventType value of 0.5 halves the speed each second. The default is 0.135. The deceleration rate is only used when inertia is enabled.
        /// </remarks>
        /// <example>
        /// <code>
        /// using UnityEngine;
