...
namespace ET
{
    public static class MongoHelper
    {
        ...
        public static void RegisterStruct<T>() where T : struct => BsonSerializer.RegisterSerializer(typeof (T), new StructBsonSerialize<T>());

        public static string ToJson(object obj) => obj.ToJson(defaultSettings);

        public static string ToJson(object obj, JsonWriterSettings settings) => obj.ToJson(settings);
        ...
        public static object FromJson(Type type, string str) => BsonSerializer.Deserialize(str, type);

        public static byte[] Serialize(object obj) => obj.ToBson();
        ...
        public static object Deserialize(Type type, byte[] bytes)
        {
            ...
            {
                throw new($"from bson error: {type.Name}", e);
            }
        }
        ...
        public static T Deserialize<T>(byte[] bytes)
        {
            ...
            {
                throw new($"from bson error: {typeof (T).Name}", e);
            }
        }

        public static T Deserialize<T>(byte[] bytes, int index, int count) => (T)Deserialize(typeof (T), bytes, index, count);

        public static T Clone<T>(T t) => Deserialize<T>(Serialize(t));
