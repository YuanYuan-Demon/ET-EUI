...
namespace ET.Client
{
    public static class TaskHelper
    {
        ...
        {
            var taskInfo = ZoneScene.GetComponent<CTasksComponent>().GetTaskInfoByConfigId(taskConfigId);
            ...
            try
            {
                m2CReciveTaskReward = await ZoneScene.Call(new C2M_ReceiveTaskReward() { TaskConfigId = taskConfigId }) as M2C_ReceiveTaskReward;
            }
            catch (Exception e)
            {
