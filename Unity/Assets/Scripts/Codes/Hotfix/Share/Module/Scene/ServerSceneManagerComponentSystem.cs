namespace ET
{
    ...
    public static class ServerSceneManagerComponentSystem
    {
        ...
        {
            protected override void Awake(ServerSceneManagerComponent self) => ServerSceneManagerComponent.Instance = self;
        }

        [ObjectSystem]
        public class ServerSceneManagerComponentDestroySystem: DestroySystem<ServerSceneManagerComponent>
        {
            protected override void Destroy(ServerSceneManagerComponent self) => ServerSceneManagerComponent.Instance = null;
        }
        ...
        public static void Remove(this ServerSceneManagerComponent self, int id) => self.RemoveChild(id);
    }
}