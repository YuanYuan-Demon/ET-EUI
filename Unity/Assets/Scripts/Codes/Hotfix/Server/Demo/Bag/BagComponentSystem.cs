...
namespace ET.Server
{
    ...
    public static class BagComponentSystem
    {
        ...
        public static bool AddItem(this BagComponent self, Item item)
        {
            ...
            ItemUpdateNoticeHelper.SyncAddItem(self.GetParent<Unit>(), item, ItemContainerType.Bag);
            return true;
        }
        ...
        public static void RemoveItem(this BagComponent self, Item item)
        {
            ...
            ItemUpdateNoticeHelper.SyncRemoveItem(self.GetParent<Unit>(), item, ItemContainerType.Bag);
            item.Dispose();
        }
