namespace ET.Server
{
    ...
    public static class TasksComponentSystem
    {
        ...
        {
            protected override void Awake(TasksComponent self)
            {
                self.Init();
            }
        }
        ...
        private static int GetTaskInitProgressCount(this TasksComponent self, int taskConfigId)
        {
        ...
        private static void UpdateAfterTaskInfo(this TasksComponent self, int beforeTaskConfigId, bool isNoticeClient = true)
        {
        ...
        public static bool IsBeforeTaskReceived(this TasksComponent self, int taskConfigId)
        {
            ...
            return beforeTaskInfo.IsTaskState(TaskState.Received);
        }
    }
}