...
namespace ET.Server
{
    ...
    {
        public static void KickPlayer(this PlayerOfflineOutTimeComponent self) => DisconnectHelper.KickPlayer(self.GetParent<Player>()).Coroutine();
...
#region 生命周期
        ...
        {
            protected override void Awake(PlayerOfflineOutTimeComponent self) => self.Timer = TimerComponent.Instance.NewOnceTimer(
        ...
        {
            protected override void Destroy(PlayerOfflineOutTimeComponent self) => TimerComponent.Instance.Remove(ref self.Timer);
        }
