...
namespace ET
{
    ...
    [ProtoContract]
    public class C2M_StartGameLevel: ProtoObject, IActorLocationRequest
    {
        [ProtoMember(1)]
    ...
    [ProtoContract]
    public class M2C_StartGameLevel: ProtoObject, IActorLocationResponse
    {
        [ProtoMember(90)]
        public int RpcId { get; set; }
    ...
    [ProtoContract]
    public class C2M_EndGameLevel: ProtoObject, IActorLocationRequest
    {
        [ProtoMember(1)]
    ...
    [ProtoContract]
    public class M2C_EndGameLevel: ProtoObject, IActorLocationResponse
    {
        [ProtoMember(90)]
        public int RpcId { get; set; }
    ...
    [ProtoContract]
    public class ProductionProto: ProtoObject
    {
        [ProtoMember(1)]
        public long Id { get; set; }
    ...
    [ProtoContract]
    public class C2M_StartProduction: ProtoObject, IActorLocationRequest
    {
        [ProtoMember(1)]
        public int ConfigId { get; set; }
    ...
    [ProtoContract]
    public class M2C_StartProduction: ProtoObject, IActorLocationResponse
    {
        [ProtoMember(1)]
    ...
    [ProtoContract]
    public class C2M_ReceiveProduction: ProtoObject, IActorLocationRequest
    {
        [ProtoMember(1)]
    ...
    [ProtoContract]
    public class M2C_ReceiveProduction: ProtoObject, IActorLocationResponse
    {
        [ProtoMember(1)]
        public ProductionProto ProductionProto { get; set; }
    ...
    [ProtoContract]
    public class M2C_AllProductionList: ProtoObject, IActorMessage
    {
        [ProtoMember(1)]
    ...
    [ProtoContract]
    public class TaskInfoProto: ProtoObject
    {
        [ProtoMember(1)]
        public int ConfigId { get; set; }
