    ...
    public sealed partial class TaskConfig: Luban.BeanBase
    {
        ...
        public TaskConfig(ByteBuf _buf)
        {
            ...
            DialogFinish = _buf.ReadString();
            {
                ...
                Targets = new System.Collections.Generic.List<TaskTarget>(n0);
                for (var i0 = 0; i0 < n0; i0++)
                {
                    TaskTarget _e0;
                    _e0 = TaskTarget.DeserializeTaskTarget(_buf);
                    Targets.Add(_e0);
                }
            }
            {
                int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);
                RewardItems = new System.Collections.Generic.List<TaskReward>(n0);
                for (var i0 = 0; i0 < n0; i0++)
                {
                    TaskReward _e0;
                    _e0 = TaskReward.DeserializeTaskReward(_buf);
                    RewardItems.Add(_e0);
                }
            }
