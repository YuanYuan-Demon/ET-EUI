...
//============================================  服务器选择流程  ============================================
	...
	public partial class A2C_GetServerInfos: ProtoObject, IResponse
	{
		...
		[ProtoMember(1)]
		public List<NServerInfo> NServerInfos { get; set; }
...
//============================================  角色创建/选择流程  ============================================
	...
	public partial class A2C_GetRoles: ProtoObject, IResponse
	{
		...
		[ProtoMember(1)]
		public List<NRoleInfo> NRoleInfos { get; set; }
...
//============================================  属性点  ============================================
	...
	public partial class C2M_AddAttributePoints: ProtoObject, IActorLocationRequest
	{
		...
		[ProtoMember(1)]
		public List<int> NumericTypes { get; set; }

		[ProtoMember(2)]
		public List<long> AddValues { get; set; }
...
//============================================  装备系统  ============================================
	...
	public partial class EquipInfoProto: ProtoObject
	{
		...
		[ProtoMember(3)]
		public List<AttributeEntryProto> AttributeEntryList { get; set; }
...
//============================================  打造系统  ============================================
	...
	{
		[ProtoMember(1)]
		public List<ProductionProto> ProductionProtoList { get; set; }
...
//============================================  任务系统  ============================================
	...
	{
		[ProtoMember(1)]
		public List<TaskInfoProto> TaskInfoProtoList { get; set; }
