...
#region UI辅助方法
        ...
        public static void RemoveUIScrollItems<Dlg, Item>(this Dlg self, ref List<Item> list) where Dlg : Entity, IUILogic
                where Item : Entity, IUIScrollItem
        {
            if (list == null)
            {
                return;
        ...
        public static void RemoveUIScrollItems<Dlg, Item>(this Dlg self, ref Dictionary<int, Item> dictionary) where Dlg : Entity, IUILogic
                where Item : Entity, IUIScrollItem
        {
            if (dictionary == null)
            {
