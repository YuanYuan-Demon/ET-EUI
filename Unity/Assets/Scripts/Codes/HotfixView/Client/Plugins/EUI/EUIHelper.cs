...
namespace ET.Client
{
    public static class EUIHelper
    {
        ...
        public static void RemoveUIScrollItems<Dlg, Item>(this Dlg self, ref Dictionary<int, Item> dictionary) where Dlg : Entity, IUILogic where Item : Entity, IUIScrollItem
        {
            if (dictionary == null)
            {
                return;
