...
namespace ET.Client
{
    ...
    public static class CameraComponentSystem
    {
        ...
        private static async void Init(this CameraComponent self)
        {
            ...
            GameObject unitGO = goComponent.GameObject;
        ...
        public static void ScrollCameraView(this CameraComponent self)
        {
            ...
            self.FramingTransposer.m_CameraDistance = Mathf.LerpAngle(self.FramingTransposer.m_CameraDistance, self.CameraDistance, Time.deltaTime * 10);
        }
        ...
        public static void RotateCameraView(this CameraComponent self)
        {
            ...
            Quaternion targetRotation = Quaternion.Euler(self.TargetPitch, self.TargetYaw, 0);
