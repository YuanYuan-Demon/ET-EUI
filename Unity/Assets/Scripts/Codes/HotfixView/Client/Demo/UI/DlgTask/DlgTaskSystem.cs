...
namespace ET.Client
{
    ...
    public static class DlgTaskSystem
    {
        ...
        {
            int count = self.ClientScene().GetComponent<TaskComponent>().GetTaskInfoCount();
        ...
        public static void OnTaskItemLoopHandler(this DlgTask self, Transform transform, int index)
        {
            ...
            TaskInfo taskInfo = self.ClientScene().GetComponent<TaskComponent>().GetTaskInfoByIndex(index);
        ...
        public static async ETTask OnClickSubmit(this DlgTask self, int taskConfigId)
        {
            try
            {
                int errorCode = await TaskHelper.GetTaskReward(self.ClientScene(), taskConfigId);
