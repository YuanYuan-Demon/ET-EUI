...
namespace ET.Client
{
    ...
    public static class DlgMessageBoxHelper
    {
        ...
        public static void ShowErrorBox(Exception error)
        {
            UIComponent.Instance.ShowMessageBox(MessageBoxType.Error, "异常", error.Message); ;
        }

        public static void ShowErrorBox(int errorCode)
        {
            UIComponent.Instance.ShowMessageBox(MessageBoxType.Error, "错误", $"错误码:{errorCode}");
        }

        public static void ShowErrorBox(string message)
        {
            UIComponent.Instance.ShowMessageBox(MessageBoxType.Error, "错误", $"{message}");
        }

        public static void ShowInfoBox(string message)
        {
            UIComponent.Instance.ShowMessageBox(MessageBoxType.Infomation, "提示", $"{message}");
        }

        public static void ShowQuestBox(string message)
        {
            UIComponent.Instance.ShowMessageBox(MessageBoxType.Question, "确认", $"{message}");
        }
    }
}