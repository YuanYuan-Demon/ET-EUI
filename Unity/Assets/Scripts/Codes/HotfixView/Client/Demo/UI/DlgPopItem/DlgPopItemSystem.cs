...
namespace ET.Client
{
    ...
    public static class DlgPopItemSystem
    {
        ...
        public static void SetItem(this DlgPopItem self, Item item, bool showButton = true)
        {
            ...
            view.EI_Icon_Image.overrideSprite = IconHelper.LoadIconSprite("Items", item.Config.Icon);
            ...
            var limitClassColor = self.ShowColor[roleClass == config.LimitClass];
