...
namespace ET.Client
{
    ...
    public static class DlgEquipSystem
    {
        ...
        public static void RefreshRoleInfo(this DlgEquip self)
        {
            ...
            view.ES_HpBar.ET_Text_TextMeshProUGUI.text = $"{nc[NumericType.Hp].ToString()}/{nc[NumericType.MaxHp].ToString()}";
            view.ES_HpBar.ED_Slider_Slider.maxValue = nc[NumericType.MaxHp];
            view.ES_HpBar.ED_Slider_Slider.value = nc[NumericType.Hp];

            view.ES_MpBar.ET_Text_TextMeshProUGUI.text = $"{nc[NumericType.MP].ToString()}/{nc[NumericType.MaxMp].ToString()}";
