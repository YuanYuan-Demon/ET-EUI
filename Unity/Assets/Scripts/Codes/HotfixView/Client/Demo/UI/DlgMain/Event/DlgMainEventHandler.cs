namespace ET.Client
{
    ...
    public class DlgMainEventHandler: IAUIEventHandler
    {
        ...
        public void OnInitComponent(UIBaseWindow uiBaseWindow) => uiBaseWindow.AddComponent<DlgMain>().AddComponent<DlgMainViewComponent>();

        public void OnRegisterUIEvent(UIBaseWindow uiBaseWindow) => uiBaseWindow.GetComponent<DlgMain>().RegisterUIEvent();
        ...
        public void OnHideWindow(UIBaseWindow uiBaseWindow) => uiBaseWindow.GetComponent<DlgMain>().HideWindow();
