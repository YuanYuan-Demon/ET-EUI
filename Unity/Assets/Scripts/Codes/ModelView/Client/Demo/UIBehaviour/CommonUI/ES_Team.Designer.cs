...
namespace ET.Client
{
	[EnableMethod]
	[ChildOf]
	public partial class ES_Team : Entity,ET.IAwake<UnityEngine.Transform>,IDestroy 
	{
		...
		public UnityEngine.UI.Text ET_TeamInfo_Text
     	{
     		get
     		{
     			...
     			{
		    		this.m_ET_TeamInfo_Text = UIHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"Header/ET_TeamInfo");
     			}
		...
		public UnityEngine.UI.Button EB_Exit_Button
     	{
     		get
     		{
     			...
     			{
		    		this.m_EB_Exit_Button = UIHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Header/EB_Exit");
     			}
		...
		public ES_TeamItem ES_TeamItem1
     	{
     		get
     		{
     			...
     			{
		    	   Transform subTrans = UIHelper.FindDeepChild<Transform>(this.uiTransform.gameObject,"Members/ES_TeamItem1");
		...
		public ES_TeamItem ES_TeamItem2
     	{
     		get
     		{
     			...
     			{
		    	   Transform subTrans = UIHelper.FindDeepChild<Transform>(this.uiTransform.gameObject,"Members/ES_TeamItem2");
		...
		public ES_TeamItem ES_TeamItem3
     	{
     		get
     		{
     			...
     			{
		    	   Transform subTrans = UIHelper.FindDeepChild<Transform>(this.uiTransform.gameObject,"Members/ES_TeamItem3");
		...
		public ES_TeamItem ES_TeamItem4
     	{
     		get
     		{
     			...
     			{
		    	   Transform subTrans = UIHelper.FindDeepChild<Transform>(this.uiTransform.gameObject,"Members/ES_TeamItem4");
		...
		public ES_TeamItem ES_TeamItem5
     	{
     		get
     		{
     			...
     			{
		    	   Transform subTrans = UIHelper.FindDeepChild<Transform>(this.uiTransform.gameObject,"Members/ES_TeamItem5");
