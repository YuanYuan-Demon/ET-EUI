...
namespace ET.Client
{
	...
	public  class DlgBagViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.Button EB_Sort_Button
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			{
		    		this.m_EB_Sort_Button = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"Panel/EB_Sort");
     			}
		...
		private UnityEngine.UI.Button m_EB_Sort_Button = null;
