...
{
	[EnableMethod]
	public partial class Scroll_Item_RoleInfo : Entity,IAwake,IDestroy,IUIScrollItem 
	{
		...
		public UnityEngine.UI.Image EI_Bg_Image
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_EI_Bg_Image = UIHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EB_Select/EI_Bg");
     				}
     				return this.m_EI_Bg_Image;
     			}
     			else
     			{
		    		return UIHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EB_Select/EI_Bg");
     			}
     		}
     	}
		...
		public UnityEngine.UI.Image EI_Avator_Image
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_EI_Avator_Image = UIHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EI_Avator");
     				}
     				return this.m_EI_Avator_Image;
     			}
     			else
     			{
		    		return UIHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EI_Avator");
     			}
     		}
     	}
		...
		public TMPro.TextMeshProUGUI ET_Info_TextMeshProUGUI
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_ET_Info_TextMeshProUGUI = UIHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"ET_Info");
     				}
     				return this.m_ET_Info_TextMeshProUGUI;
     			}
     			else
     			{
		    		return UIHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"ET_Info");
     			}
     		}
     	}
