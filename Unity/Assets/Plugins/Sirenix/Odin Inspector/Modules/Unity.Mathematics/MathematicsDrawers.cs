...
namespace Sirenix.OdinInspector.Modules.UnityMathematics.Editor
{
    ...
    public class Float3Drawer: OdinValueDrawer<float3>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            ...
            genericMenu.AddItem(new GUIContent("Forward", "Set the vector property to (0, 0, 1)"), vec == Vector3.forward,
    ...
    public class Float4Drawer: OdinValueDrawer<float4>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            ...
            genericMenu.AddSeparator("");
            genericMenu.AddItem(new GUIContent("Right", "Set the vector to (1, 0, 0, 0)"), (Vector3)vec == Vector3.right,
                () => SetVector(property, Vector3.right));
            ...
            genericMenu.AddItem(new GUIContent("Forward", "Set the vector property to (0, 0, 1, 0)"), (Vector3)vec == Vector3.forward,
                () => SetVector(property, Vector3.forward));
            genericMenu.AddItem(new GUIContent("Back", "Set the vector property to (0, 0, -1, 0)"), (Vector3)vec == Vector3.back,
                () => SetVector(property, Vector3.back));
        }
